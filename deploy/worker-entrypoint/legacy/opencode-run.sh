...
CODIFY_OPENCODE_HTTP_AUDIT_FILE="${CODIFY_OPENCODE_HTTP_AUDIT_FILE:-${CODIFY_RUNTIME_DIR}/opencode-http-audit.jsonl}"
...
mkdir -p "$(dirname "${CODIFY_OPENCODE_RAW_EVENT_JSONL}")" "$(dirname "${CODIFY_OPENCODE_HTTP_AUDIT_FILE}")"
