...
Codify — AI-powered code generation service. Users create issues in the dashboard, launch tasks, and Codify schedules execution in isolated Docker containers via Claude CLI, pushes commits, and opens Merge Requests.
