const en = {
  ...
  config: {
    ...
    defaultFallback: 'default fallback',
     ...
     ciFailureBundleRetentionDays: 'CI Bundle Retention Days',
     ciFailureBundleRetentionDaysHint: 'How long sanitized CI failure bundles remain on the worker host.',
     ...
     alertWebhookHint: 'Leave blank to keep the current stored webhook URL unchanged.',
      ...
      workerPreScriptHint: 'Runs in /workspace after checkout and before Claude CLI.',
      workerPostScript: 'Post Script',
      workerPostScriptPlaceholder: 'npm test',
      workerPostScriptHint: 'Runs in /workspace after Claude CLI succeeds and before commit.',
      hostPath: 'Host Path',
