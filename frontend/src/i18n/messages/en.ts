  ...
  config: {
    ...
    defaultFallback: 'default fallback',
     ...
     alertWebhookHint: 'Leave blank to keep the current stored webhook URL unchanged.',
      ...
      defaultExecuteRunInstruction: 'Default Implementation Mode Run Instruction',
      defaultPlanRunInstruction: 'Default Analysis Mode Run Instruction',
      ...
      workerRuntimeModeBakedImage: 'Baked image',
      ...
      workerWorkspaceHostPathRequired: 'Enter a non-empty absolute shared workspace path.',
