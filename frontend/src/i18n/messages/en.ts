const en = {
  ...
  config: {
    ...
    secretInfo:
      'OIDC secrets are stored server-side and never returned to the browser. Leave the client secret blank to keep the current stored value.',
    ...
    storedSecretCleared: 'Stored OIDC client secret cleared',
