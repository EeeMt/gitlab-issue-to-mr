const en = {
  ...
  createTask: {
    ...
    executionEnvironmentHint: 'Uses issue defaults unless overridden',
    ...
    executionEnvironmentMissing: 'Part of the default execution environment is unavailable. Check the Worker and AI Provider for this task.',
