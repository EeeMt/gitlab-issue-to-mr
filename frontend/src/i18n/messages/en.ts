const en = {
  ...
  runInstruction: {
    ...
    selectModeHint: 'Select a task mode before configuring the run instruction template',
  ...
  config: {
    ...
    defaultFallback: 'default fallback',
     ...
     alertWebhookHint: 'Leave blank to keep the current stored webhook URL unchanged.',
      ...
      defaultExecuteRunInstruction: 'Default Execute Run Instruction',
      defaultPlanRunInstruction: 'Default Plan Run Instruction',
      ciAutoRepairRunInstruction: 'CI Auto-Repair Run Instruction',
